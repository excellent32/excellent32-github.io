...
export default function Apple() {
    ...
    var handleAuthClick = function () { return __awaiter(_this, void 0, void 0, function () {
        var data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('===apple-data=', error_1);
                    return [3 /*break*/, 3];
    ...
    function startAuth() {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadAppleAuthScript()];
                    case 1:
                        _a.sent();
                        AppleID.auth.init({
                            // response_type: 'code',
...
function loadAppleAuthScript() {
    return new Promise(function (resovle, reject) {
        ...
        (_a = document.head) === null || _a === void 0 ? void 0 : _a.append(script);
    });
}
